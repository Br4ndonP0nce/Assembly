...
TABLA2
    ...
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "0" en binario	
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "L" en binario
    RETLW   b'01001000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "A" en binario
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT A NULL VALUE TO EXPRESS A SPACE 
    RETLW   b'10000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "M" en binario-
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "U" en binario
    RETLW   b'00000001'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "N" en binario
    RETLW   b'00000100'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "D" en binario
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "0" en binario	
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT A NULL VALUE TO EXPRESS A SPACE 
    RETLW   b'01001000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "B" en binario
    RETLW   b'01111001'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "R" en binario
    RETLW   b'01001000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "A" en binario
    RETLW   b'00000001'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "N" en binario
    RETLW   b'00000100'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "D" en binario
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "O" en binario
    RETLW   b'00000001'		    ;SENDS TO 7 SEGMENT THE SECOND PART OF LETTER "N" en binario
    RETLW   b'00000000'		    ;SENDS TO 7 SEGMENT A NULL VALUE TO EXPRESS A SPACE 
